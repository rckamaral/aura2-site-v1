...
const DISCORD_URL = "https://discord.com/invite/EHW4eQS2Pm";
      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="hidden md:flex items-center gap-2 text-sm font-semibold text-[#5865F2] hover:text-[#4752c4] transition-all duration-200 hover:scale-110"
            title="Discord"
          >
        ...
        <div className="md:hidden border-t border-primary/20 bg-background/95 backdrop-blur-md">
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={closeMobile}
              className="px-3 py-3 text-sm font-semibold uppercase tracking-wider text-[#5865F2] hover:bg-[#5865F2]/10 rounded-md transition-colors flex items-center gap-2"
            >
